...
func GetAllCards(db storage.IDataRepo, uid string) ([]CardRes, error) {
...
func GetCardByID(db storage.IDataRepo, uid, id string) (CardRes, error) {
...
func StoreCard(db storage.IDataRepo, uid string, req CardReq) (string, error) {
